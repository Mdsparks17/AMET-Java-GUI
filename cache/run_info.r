...
query<-" and s.stat_id=d.stat_id and d.ob_dates BETWEEN 20160101 and 20161231 and d.ob_datee BETWEEN 20160101 and 20161231 and (d.ob_hour >= 00 and d.ob_hour <= 23)"
### Process ID number ###
pid<-"462564"
### Database Name ###
...
custom_units<-""
### Project ID Name 1 ###
run_name1<-"CMAQv521_2016fh_12US1_Eval_Base"
